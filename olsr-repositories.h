...
/// A Link Tuple.
                struct LinkTuple
                {
                  ...
                  double DLQ;                                       // ADD SERHANI 11/12/2013 ----------------------------------------------
                  double RLQ;                                       // ADD SERHANI 11/12/2013 ----------------------------------------------
                  double ETX;                                       // ADD SERHANI 11/12/2013 ----------------------------------------------
                  int numHelloReceived;                             // ADD SERHANI 11/12/2013 ---------------------------------
                  int numHelloSupposed;                             // ADD SERHANI 11/12/2013 ---------------------------------
                  uint16_t lastPackSeqNum;                          // ADD SERHANI 11/12/2013 -----------------------------------
                  uint16_t InitPackSeqNum;                          // ADD SERHANI 11/12/2013 -----------------------------------
                };
