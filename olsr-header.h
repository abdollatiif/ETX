...
//----------------------- START MODIFICATION SERHANI 11/12/2013 -----------
uint8_t EtxValToEmf (double etxval);
double EmfToEtxVal (uint8_t olsrFormat);
//----------------------- END MODIFICATION SERHANI 11/12/2013 -------------
  ...
  */
  struct Hello
  {
    struct LinkMessage {
      ...
      uint8_t RLQ;                                          //---------------- ADD SERHANI 11/12/2013 ------------------------------
      uint8_t ETX;                                          //---------------- ADD SERHANI 11/12/2013 ------------------------------
