...
{
  //std::cout << "MprSelectorTuple* OlsrState::FindMprSelectorTuple (Ipv4Address const &mainAddr)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)" << std::endl;  
...
{
  //std::cout << "std::string OlsrState::PrintMprSelectorSet () const" << std::endl;  
...
{
  //std::cout << "NeighborTuple* OlsrState::FindNeighborTuple (Ipv4Address const &mainAddr)" << std::endl;
...
{
  //std::cout << "const NeighborTuple* OlsrState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const" << std::endl;
...
{
  //std::cout << "NeighborTuple* OlsrState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseNeighborTuple (const NeighborTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseNeighborTuple (const Ipv4Address &mainAddr)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertNeighborTuple (NeighborTuple const &tuple)" << std::endl;
...
{
  //std::cout << "TwoHopNeighborTuple* OlsrState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr, Ipv4Address const &twoHopNeighborAddr)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr, const Ipv4Address &twoHopNeighborAddr)" << std::endl;
...
OlsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr)
{
  //std::cout << "void OlsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)" << std::endl;  
...
{
  //std::cout << "bool OlsrState::FindMprAddress (Ipv4Address const &addr)" << std::endl;   
...
{
  //std::cout << "void OlsrState::SetMprSet (MprSet mprSet)" << std::endl;  
  m_mprSet = mprSet;
}
...
{
  //std::cout << "MprSet OlsrState::GetMprSet () const" << std::endl;  
  return m_mprSet;
}
...
{
  //std::cout << "DuplicateTuple* OlsrState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseDuplicateTuple (const DuplicateTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertDuplicateTuple (DuplicateTuple const &tuple)" << std::endl;  
...
{
  //std::cout << "LinkTuple* OlsrState::FindLinkTuple (Ipv4Address const & ifaceAddr)" << std::endl;  
...
{
  //std::cout << "LinkTuple* OlsrState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseLinkTuple (const LinkTuple &tuple)" << std::endl;
...
{
  //std::cout << "LinkTuple& OlsrState::InsertLinkTuple (LinkTuple const &tuple)" << std::endl;
...
{
  //std::cout << "TopologyTuple* OlsrState::FindTopologyTuple (Ipv4Address const &destAddr, Ipv4Address const &lastAddr)" << std::endl;
...
{
  //std::cout << "TopologyTuple* OlsrState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseTopologyTuple (const TopologyTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertTopologyTuple (TopologyTuple const &tuple)" << std::endl;
...
{
  //std::cout << "IfaceAssocTuple* OlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)" << std::endl;
...
{
  //std::cout << "const IfaceAssocTuple* OlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)" << std::endl;  
...
{
  //std::cout << "std::vector<Ipv4Address> OlsrState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const" << std::endl;
...
{
  //std::cout << "AssociationTuple* OlsrState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)" << std::endl;
...
{
  //std::cout << "void OlsrState::EraseAssociationTuple (const AssociationTuple &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertAssociationTuple (const AssociationTuple &tuple)" << std::endl;  
...
{
  //std::cout << "void OlsrState::EraseAssociation (const Association &tuple)" << std::endl;
...
{
  //std::cout << "void OlsrState::InsertAssociation (const Association &tuple)" << std::endl;  
