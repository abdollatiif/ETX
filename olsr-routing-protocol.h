...
struct RoutingTableEntry
{
  ...
  uint32_t metric;              //----------- ADD BY SERHANI -------------
  bool used;                    //----------- ADD BY SERHANI -------------

  RoutingTableEntry () : // default values
                         destAddr (), nextAddr (),
                         interface (0), distance (0), metric(65535), used(false) {};
...
public:
   ...
   **/
  std::vector<RoutingTableEntry> GetRoutingTableEntries ();
  void SetRoutingTableEntriesToUnused ();
...
private:
  ...
  void EtxTimerExpire (Ipv4Address neighborIfaceAddr);  //-------- ADD SERHANI 12/12/2013 ----------
